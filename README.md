...
ฟอร์ม LIFF ที่ทำหน้าที่ **4 อย่างในตัวเดียว** ขึ้นอยู่กับลิงก์ที่เปิดเข้ามา:
...
- เปิดด้วย `?report=daily|weekly|monthly|yearly` ต่อท้ายลิงก์ → **หน้ารายงานสรุปค่าใช้จ่ายแบบเต็ม** (ดูได้ทุกคน สลับช่วงเวลาได้ในหน้าเดียว)

ลิงก์ทั้งหมดหลัง backend เป็นคนสร้างส่งให้อัตโนมัติทาง LINE ตามจังหวะของกระบวนการ ไม่ต้องกดหาเอง (ยกเว้นลิงก์รายงานที่ได้จากการพิมพ์คำสั่ง "รายงานวันนี้" เป็นต้น ในแชท)
...
หน้านี้มีแท็บสลับช่วงเวลาในตัว ไม่จำเป็นต้องเปิดลิงก์ใหม่ทุกครั้งที่อยากดูช่วงอื่น
